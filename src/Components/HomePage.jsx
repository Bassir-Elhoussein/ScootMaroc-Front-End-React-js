...
import OfferSection from './Home/MiddlePart/OffersSection/OfferSection'
import MakeaOffer from './Home/MiddlePart/OffersSection/MakeaOffer'
    ...
    <Grid container className='px-5 lg:px-36 justify-between'xs={12}>
        ...
        <Grid item xs={12} lg={6} className={`px-5 lg:px-9 border ${theme.currentTheme==="dark"?"border-gray-800":""} `}>
          <Routes>
            ...
            <Route path='/offers' element={<OfferSection/> }></Route>
            <Route path='/make Offer' element={<MakeaOffer/>}></Route>
