...
import { createRetweet, deleteTweet,
  likeTweet,
      ...
      <div className="flex space-x-5 ">
        ...
        <div className="w-full">
          ...
          <div className="  shadow rounded-lg ">
            ...
            >
              <p className="mb-2 text-base font-medium">{twit.content}</p>
              {twit.image && (
                <div className="mt-2 w-full flex justify-center">
                <img
                  className=" w-96 max-h object-cover rounded-lg "
                  src={twit.image}
                  alt="Twit Image"
                /></div>
              )}
            ...
            <div className="py-4 flex space-x-16  mt-2">
            <div
              ...
              <div
                className="flex items-center text-gray-600 cursor-pointer space-x-2 "
                onClick={handleOpenReplyModel}
              >
                <ChatBubbleOutlineIcon />
                {twit.totalReplies > 0 && (
                  <p className="text-sm">{twit.totalReplies}</p>
                )}
              </div>
              <div
                className={`flex items-center space-x-2 ${
              ...
              >
                ...
                {retwit > 0 && <p className="text-sm">{retwit}</p>}
              </div>
              
              <div className="flex items-center text-gray-600 space-x-2">
                <BarChartIcon />
                <p className="text-sm">24,599</p>
              </div>
              <div className="flex items-center text-gray-600 space-x-2">
                <FileUploadIcon />
              </div>
            ...
            <div className="py-4 flex space-x-4 border-t border-yellow-500 mt-2"></div>
